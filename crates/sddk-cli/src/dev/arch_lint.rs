...
const C4_LEGACY_ALLOWLIST_M1: &[&str] = &[
    ...
    // A3-S3 (2026-09-15): line numbers shifted by +1 after alphabetical
    // insertion of `pub mod architecture_graph;` in lib.rs (between
    // architectural_contract and authority). Code at the three sites is
    // unchanged. See INC-A3-S1-C4-LINE-SHIFT for the underlying fragility
    // (line-number brittleness in the allowlist) and follow-up.
    "crates/sddk-engine/src/lib.rs:1168",
    "crates/sddk-engine/src/lib.rs:1295",
    "crates/sddk-engine/src/lib.rs:1355",

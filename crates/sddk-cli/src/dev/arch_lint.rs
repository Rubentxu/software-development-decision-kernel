...
const C4_LEGACY_ALLOWLIST_M1: &[&str] = &[
    ...
    // A3-S2 (2026-09-15): line numbers shifted by +1 after alphabetical
    // insertion of `pub mod architectural_contract;` in lib.rs (between
    // agent_role_contract and authority). Code at the three sites is
    // unchanged. See INC-A3-S1-C4-LINE-SHIFT for the underlying fragility
    // (line-number brittleness in the allowlist) and follow-up.
    "crates/sddk-engine/src/lib.rs:1167",
    "crates/sddk-engine/src/lib.rs:1294",
    "crates/sddk-engine/src/lib.rs:1354",

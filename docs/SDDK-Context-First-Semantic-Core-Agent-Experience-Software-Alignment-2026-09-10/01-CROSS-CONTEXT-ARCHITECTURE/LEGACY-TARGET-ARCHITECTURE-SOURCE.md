...
## Amendment 2026-09-10 — Software Alignment bounded context

```text
Decision Memory --------+             +---- Evidence Providers
                        |             |     Git / tests / CogniCode / Chronos
                        v             v
                   Knowledge substrate
                Assertions + SemanticGraph
                        |
                        v
              +-----------------------+
              |   Software Alignment  |
              ...
              +-----------+-----------+
                ...
                v                   v
             verify             deb-verify
          delta-oriented      global baseline
                |                   |
                +---------+---------+
                          v
                   ContextCompiler
...
Alignment is a peer bounded context, not a submodule of Governance. Governance may consume its evidence, but Alignment cannot authorize, block or execute side effects.

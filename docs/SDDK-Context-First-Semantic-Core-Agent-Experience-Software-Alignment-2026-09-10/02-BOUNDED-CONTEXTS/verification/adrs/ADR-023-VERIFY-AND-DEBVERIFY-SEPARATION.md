# ADR-023 — Verify and DebVerify are different use cases
...
Verify owns recent delta and impact synchronization; DebVerify owns whole-project reconciliation/debt baseline. DebVerify is not Verify --all.

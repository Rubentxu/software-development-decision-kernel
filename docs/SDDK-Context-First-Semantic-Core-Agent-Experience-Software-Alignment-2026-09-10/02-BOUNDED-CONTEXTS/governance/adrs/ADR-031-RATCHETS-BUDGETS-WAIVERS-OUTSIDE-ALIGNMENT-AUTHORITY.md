# ADR-031 — Ratchets/budgets/waivers remain governance mechanisms
...
Alignment computes relevant observations; policy decides whether budgets/ratchets block. Waivers require reason, owner, expiry/revisit and DecisionRef.

...
## Supersession 2026-09-10

This package supersedes the 2026-09-09 Semantic Core + Agent Experience package as the proposed consolidated source because it preserves that content and adds the next Software Alignment evolution. It also supersedes the standalone Progressive Knowledge/Verify-DebVerify draft.

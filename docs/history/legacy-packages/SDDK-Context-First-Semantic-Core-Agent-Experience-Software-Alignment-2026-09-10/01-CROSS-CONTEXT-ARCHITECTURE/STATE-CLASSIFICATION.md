...
## Amendment — Alignment state classes

- analyzer execution/result publication: **Fact**;
- immutable evidence bundle / behavior digest / KnowledgeBasis payload: **Object**;
- current KnowledgeCard, Workbook, chart, Alignment summary: **Projection**;
- ContextCapsule slice and temporary LLM evaluation request: **Ephemeral**.

A cell in a Workbook is never a canonical write target.

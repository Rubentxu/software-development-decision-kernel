# ADR-027 — Aggregated RPC provider boundary
...
Integrate external tools through SDDK-owned ports and high-level provider use cases. Do not mirror MCP/internal APIs or depend on provider crates in sddk-domain.

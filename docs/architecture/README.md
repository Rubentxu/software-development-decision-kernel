...
| **A5-1** | Release / distribution / version governance | `docs/architecture/a5/` | **NEXT** (not auto-opened) |
| **A5-2** | Durability / rebuild / recovery | `docs/architecture/a5/` | blocked_by A5-1 |

...
| **A5-PLAN** | A5 planning (planning only; **no** `BASE_PRODUCTION_READY` yet) | — | **NEXT** (unblocked by A4-CLOSEOUT; NOT auto-opened) |
| **A5** | `BASE_PRODUCTION_READY` — release receipts, hardening programme close | — | blocked_by A5-PLAN |

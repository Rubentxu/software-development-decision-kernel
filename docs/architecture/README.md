...
| **A5-PLAN** | A5 planning (planning only; **no** `BASE_PRODUCTION_READY`): readiness contract, risk register, debt disposition, workstream DAG, UAT + falsification matrices, release/certification protocol, deferred-post-BASE list. Detail under `docs/architecture/a5/`. | — | **CLOSED — planning** (cycle `p-63676b11dc0ef88f/a5-plan-base-production-ready`; deliverables `docs/architecture/a5/`; handoff `docs/handoff/HANDOFF-2026-09-17-a5-plan-base-production-ready.md`; planning-only, **no production release published**) |
| **A5-1** | Release / distribution / version governance — semantic push/release admission (subject is not authority; real version bump or non-empty docs-only range), rollback UAT, distribution integrity | `docs/architecture/a5/` | **CLOSED — v1.169.71** (release tag `v1.169.71` → SHA `e3fc3a09259182478c5f508bc4d51ceb958260b5`; receipt `docs/architecture/a5/A5-1-RECEIPT.md`; matrices 20+7 green; G7/G8/G15/G16 evidenced; PublicReleaseGate PASS; `INC-A5-PUSH-RELEASE-MARKER-FRICTION` + `INC-A4-RELEASE-VERSION-DRIFT` CLOSED. A5-2 NEXT — not auto-opened.) |

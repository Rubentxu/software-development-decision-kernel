...
package_source: docs/history/legacy-packages/SDDK-Semantic-Core-Agent-Experience-Consolidation-2026-09-09/02-ADRS/ADR-012-CONFIGURATION-CONVENTIONS.md
status: accepted
...
| Source | `docs/history/legacy-packages/SDDK-Semantic-Core-Agent-Experience-Consolidation-2026-09-09/02-ADRS/ADR-012-CONFIGURATION-CONVENTIONS.md` |

...
| **AIW-S2** — Captura estructurada de tests y gates | NOT_STARTED | Ningún commit en este CWD con el identificador AIW-S2. Aceptación UAT-T01..T10 sin ejecutar. **NO confundir con A6/S2** (sub-slice del macro-cycle A6 que cubre C05/C07/C09). | Falta runner real (nextest, etc.) + exposition Gateway a agent/host + receipt con status/timeout/complete/attempt/source basis/output refs/redaction. |
...
| **AIW-S6** — Correlación estático/runtime | NOT_STARTED | Aceptación UAT-P09..P12 sin ejecutar. | Requiere S1+S5 confirmados (✓) + inteligencia_loop + relations. Pendiente de A8. |
